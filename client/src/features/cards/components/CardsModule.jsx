...
function CardsModule({ authToken, onMetricsChange, onRecordsChange }) {
  ...
  const openReplaceCardModal = (card) => {
    ...
    fetchNextCardNumber(authToken)
      ...
      .catch((error) => setReplaceCardRequestError(getApiErrorMessage(error)));
  };
        ...
        <form className="form-grid" onSubmit={handleCardSubmit} autoComplete="off">
          <label className="field-group">
            ...
            <input
              ...
              placeholder="Auto-generated card number"
              autoComplete="off"
            />
          ...
          <label className="field-group">
            ...
            <SearchableSelect
              ...
              loadOptions={loadMemberSearchOptions}
              getOptionValue={(member) => member.id}
              getOptionLabel={(member) => `${member.fullName} (${member.mobileNumber})`}
              getOptionMeta={(member) => member.status}
              placeholder={isLoadingMembers ? "Loading members..." : "Search member name or mobile"}
